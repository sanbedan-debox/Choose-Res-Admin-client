...
// type Timings = {
//   [key in Day]: { open: string; close: string };
// };
...
//   const handleChange = (day: Day, field: "open" | "close", value: string) => {
//     setTimings((prev) => ({
//       ...prev,
//       [day]: {
//         ...prev[day],
...
//       <div className="w-full max-w-2xl rounded-lg p-4 overflow-y-auto">
//         <div className="grid grid-cols-1 gap-4">
//           {days.map((day) => (
//             <div
//               key={day}
//               className=" rounded-lg shadow-md flex flex-col justify-center items-center"
//               style={{
//                 boxShadow:
