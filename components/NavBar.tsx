...
//   return (
//     <nav
//       className={`bg-gray-800 text-white p-4 fixed top-0 z-10 transition-all duration-300 w-[calc(100% - ${
//         isSidebarExpanded ? "30rem" : "5rem"
//       })]`}
//     >
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`bg-gray-800 text-white p-4 fixed top-0 z-10 transition-all duration-300 ${
